...
A modular Telegram Group Management bot made using [KURUMI Chan]
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ak-kaddu/kurum)
